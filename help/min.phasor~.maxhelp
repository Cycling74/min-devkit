...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 810.0, 60.0, 150.0, 21.0 ],
					"text" : "uses the MC wrapper"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 780.0, 225.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 350.0, 535.0, 74.0, 23.0 ],
					"text" : "min.phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 290.0, 105.0, 30.0, 23.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 275.0, 140.0, 101.0, 23.0 ],
					"text" : "min.phasor~ 101."
				}
...
, 			{
				"box" : 				{
					...
					"numpoints" : 441,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 200.0, 483.0, 205.0 ],
					"subplots" : [ 						{
							"color" : [ 0.4, 0.4, 0.75, 1.0 ],
							"thickness" : 1.2,
							"point_style" : "none",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 520.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 165.0, 70.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 170.0, 140.0, 101.0, 23.0 ],
					"text" : "min.phasor~ 100."
				}
