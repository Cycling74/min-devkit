...
public:
	...
	MIN_DESCRIPTION {
		"A non-bandlimited sawtooth oscillator (a phasor~ in MSP parlance)."
		"This <a href='https://en.wikipedia.org/wiki/Sawtooth_wave'>sawtooth wave</a>"
		"is typically used as a control signal for <a href='https://en.wikipedia.org/wiki/Phase_(waves)'>phase</a> ramping."
	};
