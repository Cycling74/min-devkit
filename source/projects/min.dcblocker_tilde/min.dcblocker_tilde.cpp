...
public:
	MIN_DESCRIPTION {
		...
		"The DC offset or <a href='https://en.wikipedia.org/wiki/DC_bias'>DC bias</a>, is removed by applying a "
		"first-order highpass filter to the input."
		"<br/><br/>"
		"This first-order highpass filter algorithm is used pretty much everywhere (STK, ChucK, RTCMix, SuperCollider, "
		"Max, Pd, etc),"
		...
		"<br/><br/>"
		"For reference, in this last case, the power is attenuated by -6 db (magnitude attenuated by -12 dB) @ 0.0798 "
		"* pi,"
	...
	message<> clear {this, "clear",
		"Reset the DC-Blocking filter. Because this is an IIR filter it has the potential to blow-up, requiring a "
		"reset.",
		MIN_FUNCTION {
